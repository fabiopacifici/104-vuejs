...
<template>
  ...
  <section v-for="(records, key) in state.results" v-show="state.results.movies != ''">
    <h2>
      {{ key }}
    </h2>
    ...
    <div v-for="item in records.results">
      ...
      <img class="poster" :src="getPosterPath(item.poster_path)" alt="" v-if="item.poster_path">
      <img class="poster" width="342" src="./assets/img/poster_placeholder.png" v-else>
